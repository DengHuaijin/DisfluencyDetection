...
class PROCESS():
    ...
    def __init__(self, num_set, scaling = 1):
    ...
    def dataset_split(self, detection = None, dataset = ""):
        ...
        if dataset == "":
            ...
            train_set = sorted(os.listdir(retrain_dir))
            # np.random.shuffle(train_set)
        ...
        if  self.scaling:
            ...
            x_train_lstm, x_test_lstm = self.scale_process(x_train_lstm, x_test_lstm, feature_type = "lstm")
