...
class LSTM_Model(DNN_Model):
    ...
    def make_model(self):
        ...
        with k.name_scope("AttentionLayer_1"):
            ...
            # lstm_output_last = tf.slice(lstm_output, [0, -1, 0], [-1, 1, -1], name = "lstm_output_last")
            # lstm_output_last = tf.squeeze(lstm_output_last, axis = 1, name = "lstm_output_last")
            _, lstm_output_last = Lambda(lambda t: [t, t[:, -1, :]])(lstm_output)
            print(lstm_output_last)
        ...
        with k.name_scope("Concatenate"):
            ...
            dense_2 = Dense(128, activation = None)(dropout1)
