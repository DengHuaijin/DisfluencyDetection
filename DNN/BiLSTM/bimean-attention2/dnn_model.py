...
from tensorflow.keras.layers import LSTM, Dense, BatchNormalization, Bidirectional, PReLU, Lambda
...
class LSTM_Model(DNN_Model):
    ...
    def make_model(self):
        ...
        with k.name_scope("LSTM_features"):
            ...
            lstm_output = Bidirectional(LSTM(Config.LSTM_UNITS, return_sequences = True,  name = "lstm_sequence"))(lstm_mask)
            lstm_output2 = LSTM(Config.LSTM_UNITS, return_sequences = True, name = "lstm_last_output")(lstm_mask)
            lstm_output_last = Lambda(lambda t: tensorflow.reduce_mean(t,1))(lstm_output2)
