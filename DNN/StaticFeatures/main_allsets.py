...
def Train():
    ...
    for num_set in all_set:
        ...
        diss_classify.Train(save_model_name = save_model_name, num_set = num_set, detection = detection, dataset = "dev", load = load, tag = tag)
...
def Test():
    ...
    for num_set in all_set:
        ...
        y_test, probs, predictions = diss_classify.Test(load_model_name = model_name, num_set = num_set, detection = detection, dataset = dataset, csvfile = acc_test, load = load, tag = tag)
