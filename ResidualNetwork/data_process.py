...
class PROCESS():
    ...
    def __init__(self, num_set, scaling = 0, tag = "A05"):
        ...
        self.wavFeature_dir = Config.SPEC_FEATURE_PATH
    ...
    def scale_process(self, x_train, x_test, feature_type):
        ...
        if feature_type == "svm":
            ...
            raise ValueError("features type: svm or lstm")
    ...
    def dataset_split(self, detection = None, dataset = ""):
        ...
        index = list(range(0, 257)) # + list(range(15,40)) # + list(range(20,35))
        """ 
        ...
        for i in train_set:
            ...
            x_train_lstm.append(lstm_feature)
        ...
        for i in test_set:
            ...
            x_test_lstm.append(lstm_feature)
        ...
        return x_train_svm, x_train_lstm, y_train, x_test_svm, x_test_lstm, y_test
